...
// ==============================================================================
// 4. WEB INTERFACE HANDLERS
// ==============================================================================

/*
 * handleRoot serves the main dashboard webpage dynamically injecting
 * the 16 servo cards and their calibration values.
 */
void handleRoot() {
...
// ==============================================================================
// 3. HARDWARE CONTROL & DISPLAY
// ==============================================================================

/*
 * updateDisplay refreshes the OLED with the IP address and a gauge
 * showing the position of the last moved servo.
 */
void updateDisplay() {
...
/*
 * setCalibratedAngle maps an angle (0-180) to the specific, calibrated 
 * microsecond pulse bounds (minUs - maxUs) for a given servo channel.
 */
...
/*
 * handleSetUs receives direct raw microsecond pulses and bypasses
 * angle mapping. Used exclusively during the calibration phase.
 */
void handleSetUs() {
...
/*
 * handleCalibrate commits new minimum and maximum microsecond bounds
 * into memory for a specific servo.
 */
...
/*
 * handleSetMaster links a servo to automatically follow another servo.
 */
...
/*
 * handleSet receives standard angle (0-180) commands and routes them
 * through the calibration math to move the servo.
 */
void handleSet() {
